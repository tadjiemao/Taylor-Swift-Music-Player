    ...
    const songs = ['1989 (Taylor\'s Version).m4a', '1989.m4a', 'Cornelia Street (live).m4a', 'Daylight (live).m4a', 'Death By A Thousand Cuts (live).m4a', 'evermore.m4a', 'Fearless (Taylor\'s Version).m4a', 'Fearless.m4a', 'folklore.m4a', 'Lover.m4a', 'Midnights (The Til Dawn Edition).m4a', 'Red (Taylor\'s Version).m4a', 'Red.m4a', 'reputation.m4a', 'Speak Now (Taylor\'s Version).m4a', 'Speak Now.m4a', 'Sweeter Than Fiction.m4a', 'Taylor Swift.m4a', 'The Taylor Swift Holiday Collection.m4a'];
    const songNames = ['1989 (Taylor\'s Version)', '1989', 'Cornelia Street (live)', 'Daylight (live)', 'Death By A Thousand Cuts (live)', 'evermore', 'Fearless (Taylor\'s Version)', 'Fearless', 'folklore', 'Lover', 'Midnights (The Til Dawn Edition)', 'Red (Taylor\'s Version)', 'Red', 'reputation', 'Speak Now (Taylor\'s Version)', 'Speak Now', 'Sweeter Than Fiction', 'Taylor Swift', 'The Taylor Swift Holiday Collection'];
        ...
        window.onload = function () {
            function ClickFrontShow() {
                this.fron = ['🎵', '🎶', '🎼',
							 ...
							 '🎹', '🎸', '🎷', '🎺', '🎻', '🪕', '🥁', '🪘', '🪇', '🪈', '🪗','📯',
							 '💿', '📀', '📢', '📣', '📻', '🔊', '🔔',
							 '1989 (Taylor\'s Version)', '1989', 'Cornelia Street (live)', 'Daylight (live)', 'Death By A Thousand Cuts (live)', 'evermore', 'Fearless (Taylor\'s Version)', 'Fearless', 'folklore', 'Lover', 'Midnights (The Til Dawn Edition)', 'Red (Taylor\'s Version)', 'Red', 'reputation', 'Speak Now (Taylor\'s Version)', 'Speak Now', 'Sweeter Than Fiction', 'Taylor Swift', 'The Taylor Swift Holiday Collection'];
							 
				// 打乱顺序
				this.fron = this.fron.sort(() => Math.random() - 0.5);
